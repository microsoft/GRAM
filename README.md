...
Per concerns about misuse of this method, the code is available for use under a [research-only license](https://github.com/microsoft/GRAM/blob/main/LICENSE).
